...
class ControllerExtensionModuleDMenuEditor extends Controller {
    ...
    public function index() {
        ...
        // Main Menu HTML.
        $data['menu_type'] = 'main';
        $data['menu_main'] = $this->load->controller('extension/module/dmenu_editor/menu', $data);

        // Top Menu HTML.
        $data['menu_type'] = 'top';
        $data['menu_top'] = $this->load->controller('extension/module/dmenu_editor/menu', $data);

        // Footer Menu HTML.
        $data['menu_type'] = 'footer';
        $data['menu_footer'] = $this->load->controller('extension/module/dmenu_editor/menu', $data);

        // Social Menu HTML.
        $data['menu_type'] = 'social';
        $data['menu_social'] = $this->load->controller('extension/module/dmenu_editor/menu', $data);
